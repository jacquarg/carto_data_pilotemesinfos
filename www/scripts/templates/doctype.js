...
var pug_match_html=/["&<>]/;
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+="",";"!==r[r.length-1]?r+";":r}function doctypeTemplate(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (description, id, index, label, mainProperties, secondaryProperties, sourceDataController, spirceDataController, typology, typologyColor, updateFrequency) {pug_mixins["row"] = pug_interp = function(d, cls){
...
pug_html = pug_html + "\u003Cdiv class=\"index\"\u003E" + (pug_escape(null == (pug_interp = index) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"details\"\u003E\u003Ctable class=\"data\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003EDonnée\u003C\u002Fth\u003E\u003Cth\u003EDescription\u003C\u002Fth\u003E\u003Cth\u003EExemple\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody class=\"compact\"\u003E";
